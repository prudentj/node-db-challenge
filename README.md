...
- [x] Explain the difference between `Relational Databases` and `SQL`.
      Relational Databases are a table of relationships while SQL is one language that you use to manipulate that this type of database

- [x] Why do tables need a `primary key`?
      Tables need one value that is unique that won’t change to make sure that you access the data you ask for.
